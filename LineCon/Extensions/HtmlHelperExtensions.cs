...
//from https://www.mattlunn.me.uk/blog/2014/08/how-to-dynamically-via-ajax-add-new-items-to-a-bound-list-model-in-asp-mvc-net/
public static class HtmlHelperExtensions
{
    ...
    public static IHtmlContent EditorForMany<TModel, TValue>(this IHtmlHelper<TModel> html, Expression<Func<TModel, IEnumerable<TValue>>> propertyExpression, Expression<Func<TValue, string>> indexResolverExpression = null, bool includeIndexField = true) where TModel : class
    {
        ...
        foreach (var item in items)
        {
            ...
            {
                guid = html.Encode(guid);
            }

            if (includeIndexField)
            {
                htmlBuilder.AppendHtml(_EditorForManyIndexField<TValue>(htmlFieldNameWithPrefix, guid, indexResolverExpression));
            }

            htmlBuilder.AppendHtml(html.EditorFor(singleItemExp, null, String.Format("{0}[{1}]", htmlFieldName, guid)));
        }
    ...
    public static IHtmlContent EditorForManyIndexField<TModel>(this IHtmlHelper<TModel> html, Expression<Func<TModel, string>> indexResolverExpression = null)
    {
    ...
    private static IHtmlContent _EditorForManyIndexField<TModel>(string htmlFieldNameWithPrefix, string guid, Expression<Func<TModel, string>> indexResolverExpression)
    {
        var htmlBuilder = new HtmlContentBuilder();
        ...
        //return new IHtmlContent(htmlBuilder.ToString());
        return htmlBuilder;
    }
}
